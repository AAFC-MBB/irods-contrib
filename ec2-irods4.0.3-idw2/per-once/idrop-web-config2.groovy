 ...
 */
environments {
<<<<<<< HEAD:irods-docker/idrop/idrop-web-config2.groovy

         production {  grails.serverURL = "https://localhost:8551/idrop-web2" }

=======
	
	 production {  grails.serverURL = "http://localhost:8551/idrop-web2" } 
	 
>>>>>>> adf7ecc0cc1f996c6c8e5f6a29696af1b10c8510:ec2-irods4.0.3-idw2/per-once/idrop-web-config2.groovy
}
...
<<<<<<< HEAD:irods-docker/idrop/idrop-web-config2.groovy
 idrop.config.preset.zone="aafcZone"
=======
>>>>>>> adf7ecc0cc1f996c6c8e5f6a29696af1b10c8510:ec2-irods4.0.3-idw2/per-once/idrop-web-config2.groovy
